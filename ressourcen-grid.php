			...
			<?php
				...
				if ( $arr_posts->have_posts() ) :
					...
					while ( $arr_posts->have_posts() ) :
						...
						<article class="inner <?php the_field('category'); ?>"id="post-<?php the_ID(); ?>">
							<div class="header">
								<small><?php the_field('type'); ?></small>
							...
							<div class="title">
								...
								if( $link ):
									...
									$link_target = $link['target'] ? $link['target'] : '_self';
								?>
								<h3><a class="button" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php print the_title(); ?></a></h3>
								<?php endif; ?>
							</div>
							<?php if( get_field('tags') ): ?>
							<div class="tags">
								<small><?php the_field('tags'); ?></small>
							</div>
							<?php endif; ?>
						<div class="post-info">
